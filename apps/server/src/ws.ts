...
import * as ModelCatalogue from "./models/ModelCatalogue.ts";
...
const makeWsRpcLayer = (
  ...
  WsRpcGroup.toLayer(
    Effect.gen(function* () {
      ...
      const modelCatalogue = yield* ModelCatalogue.ModelCatalogueService;
      ...
      return WsRpcGroup.of({
        ...
        [WS_METHODS.serverGetModelCatalogueCredentialStatus]: (_input) =>
          observeRpcEffect(
            WS_METHODS.serverGetModelCatalogueCredentialStatus,
            modelCatalogue.readCredentialStatus(),
            { "rpc.aggregate": "server" },
          ),
        [WS_METHODS.serverSetModelCatalogueCredential]: (input) =>
          observeRpcEffect(
            WS_METHODS.serverSetModelCatalogueCredential,
            input.clear
              ? modelCatalogue.clearCredential()
              : modelCatalogue.setCredential(input.credentials),
            { "rpc.aggregate": "server" },
          ),
