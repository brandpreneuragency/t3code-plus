...
| Antigravity (experimental) | [Antigravity CLI](https://antigravity.google/docs/cli/headless/) | `agy`          | Run `agy` and sign in |

Codex and Claude are on by default. Cursor, Grok Build, OpenCode, and experimental Antigravity
are off by default; turn them on in **Settings** → the provider's card when you want to use them.
...
For Antigravity setup and its headless permission limitations, see
